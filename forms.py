...
class ProfessionalForm(FlaskForm):
    name = StringField('Nome Completo', validators=[DataRequired()])
    email = StringField('Email', validators=[DataRequired(), Email()])
    role = SelectField('Função', choices=[('professional', 'Fisioterapeuta'), ('secretary', 'Secretária(o)')], validators=[DataRequired()])
...
class PatientForm(FlaskForm):
    ...
    specialty = SelectField('Especialidade Principal',
        choices=[
            ('', '-- Selecione uma Especialidade --'), ('Acupuntura', 'Acupuntura'), ('Aquática', 'Aquática'),
            ('Cardiovascular', 'Cardiovascular'), ('Dermatofuncional', 'Dermatofuncional'), ('Esportiva', 'Esportiva'),
            ('Gerontologia', 'Gerontologia'), ('Trabalho', 'Saúde do Trabalhador'), ('Neurofuncional', 'Neurofuncional'),
            ('Oncologia', 'Oncologia'), ('Reumatologia', 'Reumatologia'), ('Respiratória', 'Respiratória/Reabilitação Pulmonar'),
            ('Traumato-Ortopédica', 'Traumato-Ortopédica'), ('Osteopatia', 'Osteopatia'), ('Quiropraxia', 'Quiropraxia'),
            ('Saúde da Mulher', 'Saúde da Mulher'), ('Pilates', 'Pilates')
        ],
        validators=[Optional()]
    )
